...
class Exercise extends Component {
    ...
    renderInput = ({ input, label, type, meta, min, max, id }) => {
        ...
        const helpMessage = <p className={meta.error && meta.touched ? 'help is-danger' : 'help is-invisible'}>{meta.error}</p>
        return (
            <div className="field">
        ...
        return (
            <div className="box">
                <form action="" className="form has-text-centered" onSubmit={this.props.handleSubmit(this.onSubmit.bind(this))}>
                    ...
                    <button className="button is-success is-rounded"><span className="icon"><i class={this.props.icon}></i></span></button>
                </form>
            </div>
        );
    }
